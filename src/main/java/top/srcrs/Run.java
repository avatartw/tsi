            ...
            while(success.size()<followNum&&flag>0){
                ...
                while(iterator.hasNext()){
                    ...
                    if("0".equals(post.getString("error_code"))){
                        ...
                        Integer cont_sign_num = post.getJSONObject("user_info").getInteger("cont_sign_num");
                        Integer total_sign_num = post.getJSONObject("user_info").getInteger("total_sign_num");
                        Integer miss_sign_num = post.getJSONObject("user_info").getInteger("miss_sign_num");
                        iterator.remove();
